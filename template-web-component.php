                      ...
                      <div class="<?php echo $interactive_example_grid; ?>">
                        <?php if ($interactive_example_count > 1) { ?>
                          <div class="doc_key_container">
                            ...
                            <div class="doc_key reference_key"><a href="<?php the_permalink(); ?>&subcomponent=<?php echo $interactive_example_count; ?>" target="_blank"><span class="icon-mobile"></span></a></div>
                          </div>
